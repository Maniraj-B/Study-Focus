...
<div class='footer'>
<p>If you have any questions, please contact us at adhvikreddy.02@gmail.com.</p>
</div>
</body>
</html>";
            ...
            if(mail($receiver, $subject, $body, $headers)){
                ...
                header("location: otp?mail=$receiver");
...
<head>
    ...
    <title>Verify your mail id | studyfocus</title>
...
<body>
    <div class="container mt-5">
        <h1><img src="logo.png" style="height:220px;width:250px"> Verify Your Mail Id</h1>
